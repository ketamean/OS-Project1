...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lb_introduction.setGeometry(QRect(110, 480, 181, 71))
        font = QFont()
        font.setFamilies([u"Outfit"])
        font.setPointSize(15)
        self.lb_introduction.setFont(font)
        self.lb_introduction.setStyleSheet(u"color: rgb(239, 109, 23);")
        ...
        self.lb_volumeTitle.setStyleSheet(u"color: rgb(239, 109, 23);")
        ...
        self.lb_appFeaturesTitle.setStyleSheet(u"color: rgb(239, 109, 23);")
...
"padding: 15px;\n"
"color: rgb(255, 255, 255);")
        self.lb_introduction_2 = QLabel(self.groupBox)
        self.lb_introduction_2.setObjectName(u"lb_introduction_2")
        self.lb_introduction_2.setGeometry(QRect(110, 590, 261, 51))
        self.lb_introduction_2.setFont(font)
        self.lb_introduction_2.setStyleSheet(u"color: rgb(255, 255, 255);")
        self.lb_introduction_3 = QLabel(self.groupBox)
        self.lb_introduction_3.setObjectName(u"lb_introduction_3")
        self.lb_introduction_3.setGeometry(QRect(510, 540, 301, 51))
        self.lb_introduction_3.setFont(font)
        self.lb_introduction_3.setStyleSheet(u"color: rgb(255, 255, 255);")
        self.lb_introduction_4 = QLabel(self.groupBox)
        self.lb_introduction_4.setObjectName(u"lb_introduction_4")
        self.lb_introduction_4.setGeometry(QRect(510, 590, 301, 51))
        self.lb_introduction_4.setFont(font)
        self.lb_introduction_4.setStyleSheet(u"color: rgb(255, 255, 255);")
        self.lb_introduction_5 = QLabel(self.groupBox)
        self.lb_introduction_5.setObjectName(u"lb_introduction_5")
        self.lb_introduction_5.setGeometry(QRect(110, 540, 301, 51))
        self.lb_introduction_5.setFont(font)
        self.lb_introduction_5.setStyleSheet(u"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lb_introduction_2.setText(QCoreApplication.translate("MainWindow", u"22127459 - Pham Thanh Vinh", None))
        self.lb_introduction_3.setText(QCoreApplication.translate("MainWindow", u"22127357 \u2212 Pham Tran Yen Quyen", None))
        self.lb_introduction_4.setText(QCoreApplication.translate("MainWindow", u"22127488 \u2212 Truong Thanh Toan", None))
        self.lb_introduction_5.setText(QCoreApplication.translate("MainWindow", u"22127402 \u2212 Be La Anh Thu", None))
    # retranslateUi
